...
def plot_trajec_new(df, ax=None, size_radius=5, nskip=190,
                show_wind_quivers=True, wind_quiver_index=0, wind_quiver_res=3, wind_quiver_headwidth=7,
                wind_quiver_alpha=0.5, colormap='bone_r'):
    if ax is None:
        fig = plt.figure()
        ax = fig.add_subplot(111)

    if show_wind_quivers:
        plot_wind_quivers(df, ax, wind_quiver_index=wind_quiver_index, res=wind_quiver_res,
                          headwidth=wind_quiver_headwidth, alpha=wind_quiver_alpha)
